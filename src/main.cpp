    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //output all variables for visualization and consistency check
          ...
          out_file_ << x_gt << "\t"; //p1 - GT
          out_file_ << y_gt << "\t";	//p2 - GT
          out_file_ << sqrt(vx_gt*vx_gt + vy_gt*vy_gt) << "\t";	//v_abs - GT
          out_file_ << yaw_gt << "\t";	//yaw - GT
          out_file_ << yawrate_gt << "\t";	//yaw_dot - GT
          out_file_ << vx_gt << "\t";	//v1 - GT
          out_file_ << vy_gt << "\t";	//v2 - GT
